  ...
  try {
    ...
    const prompt = lang === "ko" 
      ...
      다음 JSON 형식으로 판결을 내려주세요:
      {
        ...
        "punishment": "패자(이기지 못한 사람)가 승자를 위해 수행해야 하는 가볍고 재미있는 형량이나 벌칙. 반드시 위트 있는 '한 문장'으로만 작성하세요."
      }
      ...
      Please provide a judgment in the following JSON format:
      {
        ...
        "punishment": "A funny and lighthearted punishment or penalty that MUST be performed by the LOSER for the benefit of the winner. It MUST be written in exactly 'one witty sentence'."
      }
